...
const ced = document.getElementById("ci");
...
data.addEventListener("submit", function (eve) {
    ...
    if (nom.value.trim() == "" || nom.value.length < 1) {
        alert("No puedes participar, si no ingresas tu nombre");
        document.getElementById("nombre").focus();
    }
    else if (ced.value.trim() == "" || ced.value.length < 7) {
        alert("No puedes participar, si no ingresas un numero de cedula");
        document.getElementById("ci").focus();
    }
    else if (muni.value.trim() == "" || muni.value.length < 1) {
        alert("No puedes participar, si no ingrsas un municipio");
        document.getElementById("municipio").focus();
    }
    
    else if (edad.value.trim() == "" || parseInt(edad.value) > 100) {
        alert("Debes tener maximo 100 años para poder participar.");
        document.getElementById("edad").focus();
    }

    else if (edad.value.trim() == "" || parseInt(edad.value) < 12) {
        alert("Debes ser mayor de 11 años para participar");
        document.getElementById("edad").focus();
    }
